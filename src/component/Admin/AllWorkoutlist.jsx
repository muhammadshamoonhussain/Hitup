...
const columns = [
  ...
  { id: "exercisesname", label: "Exercises Name", minWidth: 100 },
  { id: "sets", label: "Sets", minWidth: 100 },
  ...
  const HandleDelete = async (id) => {
    try {
      const res = await fetch(
        `http://localhost:5000/api/workout/alldeleteworkout/${id}`,
        {
          method: "DELETE",
          headers: {
            "auth-token": localStorage.getItem("token"),
